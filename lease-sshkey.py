...
# Get the user name and host namefrom the ENV variables
# You should use USER and HOST as the env variables 
...
ssh.load_host_keys(os.path.expanduser("~/.ssh/known_hosts")) # make sure this points to your known_hosts file
ssh.set_missing_host_key_policy(paramiko.RejectPolicy()) # This will fail if the host is not in your known_hosts file 
